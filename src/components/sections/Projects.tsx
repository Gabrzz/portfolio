  ...
  const projects = [
    {
      ...
      title: "CRM Completo",
      year: "2026",
      techs: ["n8n", "Claude API", "Python", "PostgreSQL"],
      impact: "Automação inteligente que substituiu 90% do suporte de nível 1 em ambiente corporativo.",
      link: "#",
      // Large premium technical blueprint diagram
      graphic: (
        <svg className="w-full h-full text-white/5 group-hover:text-techBlue/10 transition-colors duration-700" viewBox="0 0 200 120" fill="none" stroke="currentColor" strokeWidth="0.5">
          <circle cx="100" cy="60" r="35" strokeDasharray="3,3" />
          <circle cx="100" cy="60" r="10" stroke="rgba(255,255,255,0.15)" fill="rgba(255,255,255,0.01)" />
          <line x1="100" y1="10" x2="100" y2="110" />
          <line x1="50" y1="60" x2="150" y2="60" />
          <rect x="85" y="45" width="30" height="30" rx="4" stroke="currentColor" strokeWidth="0.75" />
          ...
          <motion.circle 
            cx="100" cy="60" r="2.5" fill="#0072ff"
    ...
    },
    {
      ...
      year: "2025",
      techs: ["Python", "OpenAI", "Supabase", "Docker"],
      impact: "Motor de busca semântica em base documental complexa com latência inferior a 200ms.",
      link: "#",
      graphic: (
        <svg className="w-full h-full text-white/5 group-hover:text-techBlue/10 transition-colors duration-700" viewBox="0 0 200 120" fill="none" stroke="currentColor" strokeWidth="0.5">
          <rect x="40" y="30" width="35" height="60" rx="3" strokeWidth="0.75" />
          <rect x="125" y="30" width="35" height="60" rx="3" strokeWidth="0.75" />
          ...
          <circle cx="100" cy="60" r="8" stroke="#0072ff" fill="#050505" strokeWidth="1" />
    ...
    },
    {
      ...
      year: "2025",
      techs: ["Node.js", "WhatsApp API", "n8n", "Redis"],
      impact: "Estrutura autônoma de qualificação e distribuição de leads com integração ao CRM.",
      link: "#",
      graphic: (
        <svg className="w-full h-full text-white/5 group-hover:text-techBlue/10 transition-colors duration-700" viewBox="0 0 200 120" fill="none" stroke="currentColor" strokeWidth="0.5">
          <path d="M30 30h45a8 8 0 0 1 8 8v44a8 8 0 0 0 8 8h79" strokeWidth="0.75" />
    ...
    },
    {
      ...
      year: "2026",
      techs: ["Next.js", "TypeScript", "MySQL"],
      impact: "Interface em linguagem natural para geração de relatórios SQL e inteligência de negócios.",
      link: "#",
      graphic: (
        <svg className="w-full h-full text-white/5 group-hover:text-techBlue/10 transition-colors duration-700" viewBox="0 0 200 120" fill="none" stroke="currentColor" strokeWidth="0.5">
          <rect x="35" y="20" width="130" height="80" rx="4" strokeWidth="0.75" />
